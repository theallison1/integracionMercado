...
public class CardPaymentController {
    ...
    public ResponseEntity<?> createCashPayment(@RequestBody BricksPaymentDTO cashPaymentDTO) {
        try {
            ...
            // ✅ LOG DE ITEMS PARA PAGOS EN EFECTIVO (COMPLETAMENTE CORREGIDO)
            if (cashPaymentDTO.getItems() != null && !cashPaymentDTO.getItems().isEmpty()) {
                ...
                for (ProductItemDTO item : cashPaymentDTO.getItems()) {
                    // ✅ CALCULAR TOTAL MANUALMENTE - SIN getTotalPrice()
    ...
    public ResponseEntity<?> processBricksPayment(@RequestBody BricksPaymentDTO bricksPaymentDTO) {
        try {
            ...
            // ✅ LOG DETALLADO DE ITEMS RECIBIDOS (COMPLETAMENTE CORREGIDO)
            if (bricksPaymentDTO.getItems() != null && !bricksPaymentDTO.getItems().isEmpty()) {
                ...
                // ✅ Validar que los items sean válidos (COMPLETAMENTE CORREGIDO)
